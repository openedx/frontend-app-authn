...
import { AUTO_GENERATED_USERNAME_REGISTRATION_EXP_VARIATION } from './data/optimizelyExperiment/helper';
...
const RegistrationPage = (props) => {
  ...
  const registerUser = () => {
    ...
    if (flags.autoGeneratedUsernameEnabled
      || AUTO_GENERATED_USERNAME_REGISTRATION_EXP_VARIATION === autoGeneratedUsernameExpVariation) {
  ...
  const renderForm = () => {
    ...
    return (
      <>
        ...
        || (!autoGeneratedUsernameExpVariation && !(registrationEmbedded || !!tpaHint || !!currentProvider))
          ? (
